...
copy http://www.who.int/childgrowth/software/igrowup_stata.zip ///
  igrowup_stata.zip
unzipfile igrowup_stata.zip
cd `dir'
...
merge 1:1 idpers using `w', keepusing(_*)
drop _merge
...
copy http://www.who.int/growthref/tools/who2007_stata.zip ///
  who2007_stata.zip
unzipfile who2007_stata.zip
cd `dir'
